...
public class NotificationFactory {
    ...
    public void addNotification(Notification notification) {
        try {
            ...
            PreparedStatement sqlStatement = connection.prepareStatement("INSERT INTO nokiaapp.notification( UserID, SourceID, Flag, Topic, Message, Priority) VALUES(?,?,?,?,?,?)");
            //sqlStatement.setInt(1, notification.getNotificationID());
            sqlStatement.setInt(1, notification.getUserID());
            sqlStatement.setInt(2, notification.getSourceID());
            sqlStatement.setBoolean(3, notification.getFlag());
            sqlStatement.setString(4, notification.getTopic());
            sqlStatement.setString(5, notification.getMessage());
            //sqlStatement.setTimestamp(7, notification.getTime());
            sqlStatement.setInt(6, notification.getPriority());
     ...
     *
     * @param id name of country to find
